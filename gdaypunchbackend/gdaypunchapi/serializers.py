...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("first_name", "last_name", "username", "email", "bio", "privileges", "verified",
                  ...
                  "customer_payment_details", "last_ip", "image", "cover", "last_login", "author_details")
...
class CustomerSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ("id", "user", "subscribed", "phone_number", "email", "first_name", "last_name",
                  ...
                  "last_3_purchases", "mag_subscribed", "dig_subscribed", "owned_access_count",
...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ("id", "title", "description", "image", "product_type", "active_price", "sale_price",
                  ...
                  "purchased", "subscription_interval", "saved", "saved_date", "saves", "user_avatar")
