      ...
      <FeaturedSection top>
        ...
        <ContentContainer>
          <p>
            ...
            <br />
            <strong>Gday Punch Pty Ltd</strong>
            <br />
            <em>
              This Refund Policy ("Policy") applies to all purchases from us,
            ...
            <br />
            <span>
              We offer refunds, repairs and replacements in accordance with
              the&nbsp;
            </span>
            <em>Australian Consumer Law</em>
            <span>&nbsp;and on the terms set out in this Policy.</span>
            <br />
            <span>
            ...
            <span>
              ...
              understand your rights as well as what you can expect from us in
              the event that you are not happy with your purchase.
            </span>
            <br />
            <br />
            <span>​</span>
            ...
            <em>
              ...
              <br />- to a refund for the unused portion, or to compensation for
              its reduced value.
            </em>
            <br />
            <em>
              ...
              not amount to a major failure, you are entitled to have the
              failure rectified in a reasonable time. If this is not done you
              are entitled to a refund for the goods and to cancel the contract
              for the service and obtain a refund of any unused portion. You are
            ...
            <em>Australian Consumer Law</em>
            <span>
              &nbsp;provides a set of Consumer Guarantees which protect
            ...
            <em>Australian Consumer Law</em>
            <span>
              &nbsp;applies, then we cannot avoid the Consumer Guarantees which
              it provides. If there is an inconsistency between this Policy and
              the&nbsp;
            </span>
            <em>Australian Consumer Law,</em>
            <span>&nbsp;the&nbsp;</span>
            <em>Australian Consumer Law</em>
            <span>&nbsp;will prevail.</span>
            <br />
            <br />
            <span>(e) Further information about the&nbsp;</span>
            <em>Australian Consumer Law</em>
            <span>
              &nbsp;and these Consumer Guarantees is available from the website
              of the&nbsp;
            </span>
            <em>Australian Competition and Consumer Commission.</em>
            <br />
            <span>
              (f) If a product or service which you purchased from us has a
              major failure (as defined in the&nbsp;
            </span>
            <em>Australian Consumer Law</em>
            <span>
              ) then you may be entitled to a replacement or refund. You may
              also be entitled to compensation for any reasonably foreseeable
              loss or damage resulting from that major failure.
            </span>
            <br />
            <span>
              (g) If a product or service which you purchased from us has a
              failure which does not amount to a major failure (as defined in
              the&nbsp;
            </span>
            <em>Australian Consumer Law</em>
            <span>
              ) then you may still be entitled to have the goods repaired or
              replaced.
            </span>
            <br />
            <br />
            ...
            <br />
            <span>(a) Please contact us as soon as possible.</span>
            <br />
            <span>
              (b) Any damaged product must be returned in the condition it was
              in when you received it, together with any packaging and other
              items which you received with the damaged product.
            </span>
            <br />
            <span>
              (c) We will organise to repair the damaged product or to collect
              it and replace it with an equivalent product, or to provide a
              refund, provided that you contact us within the following time
              from the date you received the product: 5
            </span>
            <br />
            <br />
            <br />
            ...
            <span>
              ...
              to provide a repair, replacement or refund for a product or
            ...
            <span>
              ...
              asked for alterations to a product, against our advice, or you
              were unclear about what you wanted.
            </span>
            <br />
            <span>(d) Any other exceptions apply under the&nbsp;</span>
            <em>Australian Consumer Law.</em>
            <br />
            <br />
            <br />
            <strong>(6) SHIPPING COSTS FOR RETURNS</strong>
            <br />
            <span>
              (a) In the event that a product you purchased fails to meet one or
              more Consumer Guarantees under the&nbsp;
            </span>
            <em>Australian Consumer Law</em>
            <span>
              &nbsp;we will bear any costs of shipping the said product (the
              "Returned Product") back to us, as well as any costs of shipping
            ...
            <em>Australian Consumer Law</em>
            <span>
              ) then we will reimburse you for the reasonable postage, shipping
              or transportation costs for the Returned Product.
            </span>
            <br />
            <span>
              (c) If the Returned Product is too large, too heavy, or otherwise
              too difficult to be removed and returned by you, and is believed
              to be eligible for a repair, replacement or refund under the terms
              of this Policy (including under the&nbsp;
            </span>
            <em>Australian Consumer Law</em>
            <span>
              ), then we will organise for the postage, shipping, transportation
              or collection of the Returned Product, at our cost.
            </span>
            <br />
            <span>
            ...
            <em>Australian Consumer Law</em>
            <span>
              ), then you will be required to pay the costs of any inspection,
              postage, shipping, transportation or collection of the Returned
              Product.
            </span>
            <br />
            <br />
            ...
            <span>
              ...
              relation to their products, and they may be able to resolve your
              issue more quickly.
            </span>
            <br />
            <span>
            ...
            <span>
              ...
              refunds within 5 days of having received them.
            </span>
            <br />
            <br />
            <br />
            ...
            <span>
              ...
              identification document in order to be eligible for a refund,
